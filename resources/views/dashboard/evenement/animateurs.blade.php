                                        ...
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li>
                                                <a data-toggle="modal" data-target="#attribution" class="btn btn-white btn-outline-light">
                                                    <em class="icon ni ni-plus"></em>
                                                    <span>AJOUTER OU MODIFIER L'ANIMATEUR A UN EVENEMENT</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li class="nk-tb-action">
                                                        <form action="{{ route('animateurs.destroy' , $sec->id)}}" method="POST">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body modal-body-lg">
                                                        ...
                                                        <form action="{{route('animateurs.update', $sec->id)}}"
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane active" id="personal">
                                                                    <div class="row gy-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label class="form-label" for="nom">Organisation</label>
                                                                                <input type="text" class="form-control form-control-lg"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body modal-body-lg">
                                                    ...
                                                    <form action="{{route('animateurs.store')}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="personal">
                                                                <div class="row gy-4">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body modal-body-lg">
                                                    ...
                                                    <form action="{{route('updates_animateurs')}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @csrf
                                                        ...
                                                        <br>
                                                        <select class="form-control" name="anim" id="anim">
