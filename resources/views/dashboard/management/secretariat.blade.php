                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Secrétariat Général</h3>
                                <div class="nk-block-des text-soft">
                                    <p>
                                        {{count($secretariat)}} Membre (s)
                                    </p>
                                </div>
                            ...
                            <div class="card-inner">
                                <table class="datatable-init nowrap nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col tb-col-lg"><span class="sub-text">Fonction</span></th>
                                        <th class="nk-tb-col tb-col-md"><span class="sub-text">Action</span></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse($secretariat as $sec)
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li class="nk-tb-action">
                                                        <form action="{{ route('managements.destroy' , $sec->id)}}" method="POST">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body modal-body-lg">
                                                        <h5 class="title">Update Secretariate</h5>
                                                        <ul class="nk-nav nav nav-tabs">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" data-toggle="tab" href="#personal">Informations</a>
                                                            </li>
                                                        </ul><!-- .nav-tabs -->
                                                        <form action="{{route('managements.update', $sec->id)}}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            {{ method_field('PUT') }}
                                                            <div class="tab-content">
                                                                <div class="tab-pane active" id="personal">
                                                                    <div class="row gy-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label class="form-label">Type de Personnel : {{$sec->type}}</label>
                                                                                <div class="form-control-wrap">
                                                                                    <select class="form-select form-control form-control-lg"
                                                                                            name="type"
                                                                                            data-search="on">
                                                                                        <option value="Secrétaire Général">Secrétaire Général</option>
                                                                                        <option value="Assitante de Direction">Assitante de Direction</option>
                                                                                        <option value="Chargé de l'administration">Chargé de l'administration</option>
                                                                                        <option value="Chargé des Finances">Chargé des Finances</option>
                                                                                        <option value="Chargé des Evénements">Chargé des Evénements</option>
                                                                                        <option value="Chargé des Adhésions">Chargé des Adhésions</option>
                                                                                        <option value="Chargé des Publications">Chargé des Publications</option>
                                                                                        <option value="Chargé des Formations">Chargé des Formations</option>
                                                                                        <option value="Chargé des Relations Publiques">Chargé des Rélations Publiques</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    ...
                                                                                    <input type="password" class="form-control form-control-lg"
                                                                                           name="password" value="{{$sec->password}}"
                                    ...
                                    <div class="modal fade" tabindex="-1" role="dialog" id="update">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                                                <div class="modal-body modal-body-lg">
                                                    <h5 class="title">Add Secretariate</h5>
                                                    <ul class="nk-nav nav nav-tabs">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-toggle="tab" href="#personal">Informations</a>
                                                        </li>
