                                    ...
                                    <div class="col-lg-7 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mt-sm-0 mt-4">
                                        ...
                                        <p class="text-lg mb-0" style="color: black">
                                            ...
                                            <a type="button"
                                                ...
                                                <b>Mimile Mukuna Maisha</b> <span>(Bio)</span>
                                            </a>
                                            <br>
                                            <a href="javascript:;" class="text-info icon-move-right" data-bs-toggle="modal" data-bs-target="#messageModal">Read Full Message
