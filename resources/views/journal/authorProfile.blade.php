            ...
            <div class="card p-4">
                <div class=" image d-flex flex-column justify-content-center align-items-center">
                    <button class="btn btn-secondary">
                        <img src="{{asset($author->image)}}" height="100" width="100" style="object-fit: cover" />
                    </button>
                    <span class="name mt-3">{{$author->firstName . ' ' . $author->lastName}}</span>
                    <span class="idd">{{$author->email}}</span>
